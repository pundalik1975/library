...
unsigned int table_p[]={-8388,-6176,-4054,-2000,0,1955,3870,5730,7554,9335,11075,12775,14432,16052,17635,19171,20685,22158};
...
//                  mbamount = 16;
//                 if (mbaddress+(mbamount*2) >= 40 || mbamount >=16)
//                    {
//                    error_code = mbillegaldatavalue;         //requested data overflow
//                    break;
//                    }
//                    if(rx_buffer[6] != CRC16(rx_buffer,6))
//                    {
