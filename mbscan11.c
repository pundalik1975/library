...
/*******************************************************
derived from mbscan10
to add print function to check printer 232 output
...
else if (gen[2] ==3)   //2400 baud //115200 baud
{
UBRRH=0x02;
UBRRL=0x3f;
}
...
//        mb_dir =0;
//        delay_ms(2);
        printf("channel -1   %10u    \n",process_value[0]);
        printf("channel -2   %10u    \n",process_value[1]);
        printf("channel -3   %10u    \n",process_value[2]);
        printf("channel -4   %10u    \n",process_value[3]);
        printf("channel -5   %10u    \n",process_value[4]);
        printf("channel -6   %10u    \n",process_value[5]);
        printf("channel -7   %10u    \n",process_value[6]);
        printf("channel -8   %10u    \n",process_value[7]);
